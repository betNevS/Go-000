...
func (c *userClient) RegisterUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserReply, error) {
	out := new(UserReply)
...
func (UnimplementedUserServer) RegisterUser(context.Context, *UserRequest) (*UserReply, error) {
